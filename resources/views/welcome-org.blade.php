...
<head>
    ...
    <title>My Prospect Tracker | Smart Follow-Up CRM for Network Marketing</title>
...
<section class="text-center pt-20 bg-gray-50 relative">
    ...
    <p class="text-lg text-gray-600 max-w-xl mx-auto mb-6">
        Grow your network marketing business with smart follow-ups, a distraction-free dashboard, and motivational streaks that help you stay consistent — all in one simple tool.
    </p>
...
<section class="bg-gray-100 py-16 px-4 text-center">
    ...
    <div class="max-w-3xl mx-auto text-gray-700">
        <p>We take your data seriously. Every contact you add is encrypted. We never share your information.</p>
        <p class="mt-4">Be one of the first to use My Prospect Tracker to simplify your follow-ups and stay consistent.</p>
    </div>
</section>
...
<section class="py-16 px-4 text-center bg-primary text-white">
    <div class="relative w-full h-64 overflow-hidden leading-none">
        <svg class="absolute bottom-0 w-full h-full rotate-180" viewBox="0 0 900 601" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 480L21.5 491.8C43 503.7 86 527.3 128.8 535.8C171.7 544.3 214.3 537.7 257.2 525.3C300 513 343 495 385.8 484.8C428.7 474.7 471.3 472.3 514.2 482.2C557 492 600 514 642.8 520C685.7 526 728.3 516 771.2 518.2C814 520.3 857 534.7 878.5 541.8L900 549L900 601L878.5 601C857 601 814 601 771.2 601C728.3 601 685.7 601 642.8 601C600 601 557 601 514.2 601C471.3 601 428.7 601 385.8 601C343 601 300 601 257.2 601C214.3 601 171.7 601 128.8 601C86 601 43 601 21.5 601L0 601Z"
                  fill="#2563eb" />
        </svg>
    </div>
